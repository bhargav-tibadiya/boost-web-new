...
const TokenInfo = () => {
  return (
    <div className="gap-[12px] flex flex-row sm:flex-col">

      <div className="flex flex-col sm:flex-row sm:justify-between gap-[8px] px-[24px] sm:px-[12px] py-[24px] sm:py-[12px] border-[1px] w-full border-[#d9d9d9] max-w-[750px] rounded-[20px] sm:rounded-[10px]">
